...
python calculate_scored_lists.py -n 5 -f fps.txt -s Tanimoto -o tani_eucl_$now
echo 'Runnning for eucl/tani distance: Compressed FPs'
python calculate_scored_lists.py -n 5 -f comp_fps.txt -s Euclidean -a -o tani_eucl_$now
mkdir cos_$now
echo 'Runnning for cos distance: Classical FPs'
python calculate_scored_lists.py -n 5 -f fps.txt -s Cosine_bit -o cos_$now
echo 'Runnning for cos distance: Compressed FPs'
python calculate_scored_lists.py -n 5 -f comp_fps.txt -s Cosine -a -o cos_$now
